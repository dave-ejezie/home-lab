...
**Recent Setup References:** 
See `AD-DS/GPOs/screenshots` for examples of successful account creations (`Ad-Users-1.png`, `Ad-Users-confirmation.png`) and Security Group setup (`sg-creation-terminal.png`, `user-groups-cinfirmation.png`).
